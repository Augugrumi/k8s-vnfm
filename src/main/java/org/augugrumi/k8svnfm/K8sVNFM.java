...
public class K8sVNFM extends AbstractVnfmSpringAmqp {
    public static void main(String[] args) {
        SpringApplication.run(K8sVNFM.class);
    }
     ...
     */
    @Override
    public VirtualNetworkFunctionRecord instantiate(VirtualNetworkFunctionRecord virtualNetworkFunctionRecord, Object o, Map<String, Collection<BaseVimInstance>> map) throws Exception {
        return null;
    }
